...
############
if REALISTIC:
    scenarios = ["80-400-realistic/"]  #REALISTIC
else:
    scenarios = ["2-4-8-16/", "2-4-8-16_balanced/", "2-4-8-16_multicore/", "2-4-8-16_powerfull/", "2-4-8-16_no_reply/", "2-4-8-16_one_class/", "80-400/"]

if REALISTIC:
    max_values = [3.0]  #REALISTIC
    if MAX_VALUE_YES:
        max_values = [None]  #REALISTIC
else:
    max_values = [5.0, 2.5, 2.5, 4.3, 2.5, 0.07, 0.25]
    if MAX_VALUE_YES:
        max_values = [None, None, None, None, None, None, None]
