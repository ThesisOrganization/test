...
def plot(files_list, name_files, path_out):
    ...
    for list_policy_files in files_list:
        ...
        draw_histograms(list(final_result), names, "Utilization factor", "Element Type", "U", 0.0, 1.0, PATH=path_out + directory_name + name_files[index_file][0] + "_" + name_files[index_file][1])
